...
import static com.shehuan.test.easymvp.net.exception.Code.PARSE_ERROR;
import static com.shehuan.test.easymvp.net.exception.Code.REQUEST_TIMEOUT;
import static com.shehuan.test.easymvp.net.exception.Code.SERVICE_UNAVAILABLE;
import static com.shehuan.test.easymvp.net.exception.Code.SSL_ERROR;
import static com.shehuan.test.easymvp.net.exception.Code.TIMEOUT_ERROR;
import static com.shehuan.test.easymvp.net.exception.Code.UNAUTHORIZED;
import static com.shehuan.test.easymvp.net.exception.Code.UNKNOWN_ERROR;
